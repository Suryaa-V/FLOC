...
public class RegistrationLocators {
	...
	public String cutButtonDev() {
		return "/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.RelativeLayout/android.widget.FrameLayout/android.webkit.WebView/android.webkit.WebView/android.view.View[3]/android.widget.Image";
	}
	...
	public String okButtonInvalidOTP() {
